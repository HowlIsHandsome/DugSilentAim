...
getgenv().Aiming = {
    ...
    TargetPart = {"Head", "LowerTorso", "UpperTorso", "RightUpperLeg", "LeftUpperLeg", "HumanoidRootpart", "Humandoid",},
...
function Aiming.GetClosestTargetPartToCursor(Character)
    ...
    -- // lol fuck this nigga named owen
...
-- // I swear to god owen if you leak this shit after I fucking remade it and took down every other one im going to fucking rape u